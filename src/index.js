...
ClamScan.then(async (clamscan) => {
  try {
    console.log("clamScan read file from disk");
...
ClamScanSocket.then(async (clamscan) => {
  for (let i = 0; i < 10; i++) {
    streamScan(i.toString(), clamscan);
  }
});
...
// console.log("clamScan read file from socket");
...
// for (let i = 0; i < 10; i++) {
//   const readableStream = fs.createReadStream("./tmp/" + i + ".png");
